...
(supplement), making systematic deprioritization visible. These tradeoffs are real: under
...
Third, the priority weights $\omega_s$ encode a value judgment, not a
fact; we expose them as configuration, vary them in sensitivity analysis,
and regard their selection in any real setting as a decision for
accountable public officials, not a model.
