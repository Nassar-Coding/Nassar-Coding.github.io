...
value judgment, not a fact; we expose them as configuration, vary them in
sensitivity analysis, and regard their selection in any real deployment as
a decision that belongs to accountable public officials, not to a model.
