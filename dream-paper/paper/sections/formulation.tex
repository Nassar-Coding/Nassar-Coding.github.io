...
labeled sensitivities). The decision loss over the test horizon $\mathcal{T}$ is
\begin{equation}
...
$\kappa$ sets only the scale of a capacity unit and is varied as a
labeled sensitivity. Nothing in
