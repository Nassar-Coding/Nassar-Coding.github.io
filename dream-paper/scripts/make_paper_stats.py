...
def data_stats() -> str:
    ...
    return (
        ...
        "eight defined service-family categories with city-specific active "
        "sets: Chicago has seven because the noise family is structurally "
        "absent; no synthetic data). Counts cover the densified study window; "
        "modeling uses the shorter frozen weather-joined span through "
        "2025-02-05 (see text).}\n"
        "\\label{tab:data}\n"
