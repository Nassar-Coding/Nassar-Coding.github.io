...
def data_stats() -> str:
    ...
    return (
        ...
        "densified study window over the full acquired/retained 2020--2025 "
        "requests; forecasting and decision evaluation use the shorter modeled "
        "span --- the frozen weather-joined common evaluation panel --- through "
        "2025-02-05, so not all retained requests enter modeling (see text).}\n"
        "\\label{tab:data}\n"
